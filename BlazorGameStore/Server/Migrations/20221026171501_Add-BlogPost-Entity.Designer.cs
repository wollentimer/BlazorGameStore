...
namespace BlazorGameStore.Server.Migrations
{
    ...
    [Migration("20221026171501_Add-BlogPost-Entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorGameStore.Shared.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorGameStore.Shared.Edition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorGameStore.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("BlazorGameStore.Shared.Stats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorGameStore.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorGameStore.Shared.Edition", "Edition")
                        .WithMany()
                        .HasForeignKey("EditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorGameStore.Shared.Product", "Product")
                        .WithMany("Variants")
